<x-admin-layout>
  <div id="userPage">
    <div class="max-w-6xl mx-auto font-hanken">
      ...
      <x-admin.page-title title="Users Management" />
      ...
      {{-- TABLE --}}
      <div id="userTableWrapper" class="overflow-x-auto">
        @include('admin.users.partials._table')
      </div>

      {{-- PAGINATION --}}
      <div id="userPagination" class="mt-8 flex justify-center"></div>
...
<div id="userModal"
  ...
  <div class="absolute inset-0 flex items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-2xl rounded-xl relative">
